...
public class CommonRecyclerViewHolder extends RecyclerView.ViewHolder {
	...
	private int mLayoutId;				// 下标索引
	private Context mContext;			// 上下文对象
	private View mConvertView; 			// 当前项的convertView

	public CommonRecyclerViewHolder(Context context, int mLayoutId, View itemView) {
		super(itemView);
	 ...
	 * @param viewType    	item 类型
	 * @return 			通用的CommonViewHolder实例
	 */
	protected static CommonRecyclerViewHolder newInstance(Context context, View convertView, ViewGroup parent, int layoutId, int viewType) {
		CommonRecyclerViewHolder holder = null;
		if (convertView == null) { 		// 空则新建
			View itemView = LayoutInflater.from(context).inflate(layoutId, parent, false);
			holder = new CommonRecyclerViewHolder(context, layoutId, itemView);
	 ...
	 */
	public CommonRecyclerViewHolder setText4Tv (int textViewId, String text)	{
	 ...
	 * @return 			CommonRecyclerViewHolder 本身
	 */
	public CommonRecyclerViewHolder setText4Tv (Context context, int textViewId, int resId)	{
		TextView tv = getViewById(textViewId);
		if (null == tv) {		// 判空
			throw new RuntimeException("CommonRecyclerViewHolder  --> setText4Tv  Fail\n"
					+ "tv == null, please check your textViewId");
	 ...
	 * @return 			CommonRecyclerViewHolder 本身
	 */
	public CommonRecyclerViewHolder setColor4Tv (int textViewId, int color)	{
		TextView tv = getViewById(textViewId);
		if (null == tv) {		// 判空
	 ...
	 * @return 			CommonRecyclerViewHolder 本身
	 */
	public CommonRecyclerViewHolder setImage4Img (int imageViewId, int drawableId)	{
	 ...
	 * @return 			CommonRecyclerViewHolder 本身
	 */
	public CommonRecyclerViewHolder setImage4Img (int imageViewId, Bitmap bitmap)	{
		ImageView img = getViewById(imageViewId);
		if (null == img) {        // 判空
			throw new RuntimeException("CommonRecyclerViewHolder  --> setImage4Img  Fail\n"
					+ "img == null, please check your imageViewId");
	 ...
	 * @return 			CommonRecyclerViewHolder 本身
	 */
	public CommonRecyclerViewHolder setCheck4CheckBox(int checkViewId, boolean isCheck) {
	 ...
	 * @return 			CommonRecyclerViewHolder 本身
	 */
	public CommonRecyclerViewHolder setClickEnablility (int viewId, boolean clickAble) {
		View view = getViewById(viewId);
		if (null == view) {
	 ...
	 * @return 			CommonRecyclerViewHolder 本身
	 */
	public CommonRecyclerViewHolder setOnItemClickListener (View.OnClickListener listener) {
